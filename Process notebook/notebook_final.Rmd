...
title: |
  <center>R Process Notebook</center>
   ![](./data/covid.png){width=650px style="display: block; margin:0 auto"}  
...
# **Related Work**
Since the beginning of the year almost every day goes by where the corona virus is not reported in the news and other sources. It determines politics, economy and our own lives. 

Scientists all over the world analyse [@dey2020analyzing] and try to make predictions [@gupta2020trend], [@singh2020development]. 
There are also various simulations to understand how the virus spreads, how to influence the R-factor and what the future could look like under certain parameters [@ncase].  With regard to the John Hopkins University data set, there are many visualizations: Figures on new cases, new infections both worldwide or with focus on Germany [@zdf]. <br>

Furthermore there are analyses of COVID-19 data with gender, age and death rate [@rTutorial]
Nowadays sentiment analysis and opinion mining have become most popular research topics especially for social data[@manguri2020twitter].During the lock down people have used social media platforms like facebook, twitter etc massively to express their feelings and relief the stress they have. Also During the pandemic time considerable researches also have been performed on those data to understand how different people express their emotions and how they delft with this unfortunate situation[@manguri2020twitter],[@dubey2020twitter]. Getting an insight about the feelings and emotions will help to analyze the situation better and help in uplifting the mental health of public.

# **Initial Questions**
To get an overview, we have divided it into three domains: Twitter, a medical data set of patients infected with novel coronavirus and the popular Johns Hopkins University dataset. <br>
At the beginning of April our questions were still very general, such as
Can we identify some trends? <br>
